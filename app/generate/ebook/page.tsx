...
export default function EbookGenerator() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setError('An error occurred while generating the ebook.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-4 pt-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">Ebook Generator</h1>
        <div className="bg-white p-6 rounded-lg shadow-md mb-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Ebook Description</h2>
          <textarea
            value={prompt}
            onChange={(e) => setPrompt(e.target.value)}
            placeholder="Describe the ebook, e.g., 'Short ebook about morning habits for busy parents, 5 chapters'"
          ...
          <div className="text-center mt-4">
            ...
            >
              {isLoading ? 'Generating...' : 'Generate Ebook'}
            </button>
          </div>
        </div>
        {isLoading && (
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Generating your ebook...</p>
          </div>
        )}
        {downloadUrl && (
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Download Your Ebook</h2>
            <a
              href={downloadUrl}
              download="ebook.pdf"
